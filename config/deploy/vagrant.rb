...
# to the vagrant machine provisioned for the bebox-simple_web_app,

set :stage, :vagrant
set :user, "simple_web_app"
set :group, "simple_web_app"
# the ssh_key used here is the same that the provided by the bebox-simple_web_app project.
